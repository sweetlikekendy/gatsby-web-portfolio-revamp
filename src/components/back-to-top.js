...
const BackToTop = () => {
  ...
  return (
    <div className="my-4 flex flex-col justify-center items-center mx-auto md:mt-24 md:mx-auto md:mb-8 ">
      <button
        id="button-up"
        className="to-top-link text-white bg-blue-500 rounded-full h-20 w-20 mb-4 shadow-md flex justify-center items-center cursor-pointer bg-transparent border-none transition-colors focus:outline-none focus:border-gray-700 md:hover:bg-blue-600 md:hover:shadow-lg md:active:bg-blue-700 md:active:shadow-2xl"
        onClick={handleClick}
      >
